...
namespace PMF_Movie_Store.Controllers
{
    public class CustomersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken] //provjeravamo AntiForgeryToken
        public ActionResult Save(Customer customer)
        {
            ...
            if (customer.Id == 0) // if new customer
                _context.Customers.Add(customer);
            else // if customer exists --> update
            {
            ...
            // redirect back to list of customers
